...
const Services = () => {
  ...
  return (
    <section id="services" className="relative py-24 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#E9EDF4] to-white"></div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#515167]">
              Next-Gen <span className="bg-gradient-to-r from-[#363636] to-[#515167] bg-clip-text text-transparent">Solutions</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {services.map((service, index) => (
              <div key={index} className="group">
                <Card className={`relative bg-[#E9EDF4] backdrop-blur-sm border hover:border-white/20 transition-all duration-300 transform hover:-translate-y-1 h-full`}>
                  <CardHeader className="pb-4">
                    <div className="flex items-start gap-4">
                      {/* Simplified Icon */}
                      <div className={`flex-shrink-0 w-12 h-12 bg-[#30303E] rounded-xl border ${service.borderColor} flex items-center justify-center`}>
                        <span className={`text-2xl text-white  group-hover:text-white transition-colors`}>
                          {service.icon}
                        </span>
                      </div>
                      
                      <div className="flex-1">
                        <CardTitle className="text-lg font-semibold text-[#30303E] mb-2 group-hover:text-[#515167] transition-colors">
                          {service.title}
                        </CardTitle>
                      </div>
                    </div>
